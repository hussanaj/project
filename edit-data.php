...
$sql6 = "SELECT * FROM aquatic_animals AS d1 
...
if (isset($_POST['submit'])) {
    ...
    $sql1 = " UPDATE `aquatic_animals` SET `name_animal`='$fishname',`fish_pond`= $fish_pond,`year_age`= $agey,`month_age`= $agem,
    `amount_animal`= $amount,`date_release`= '$datet',`quantity_food`= $quantity,`reduce_food`= $​​reduce_food,`time_feed`= $time_feed
     WHERE 	fish_pond = $fish_pond";
    

    if ($conn->query($sql1) === TRUE) {
        $sql2 = "UPDATE `time_food` SET `fish_pond`= $fish_pond,`time_1`= '$timefood1',`time_2`= '$timefood2',`time_3`= '$timefood3',`time_4`= '$timefood4',`time_5`= '$timefood5' WHERE fish_pond = $fish_pond ";
    ...
    if ($conn->query($sql2) === TRUE) {
       ...
       $sql3 = " UPDATE `sensor_standard` SET `fish_pond`= $fish_pond,`value1_min`= $value1_min,`value1_max`= $value1_max,`value2_min`=$value2_min,`value2_max`= $value2_max,`value3_min`= $value3_min,
       `value3_max`= $value3_max,`value4_min`= $value4_min,`value4_max`= $value4_max,`value5_min`= $value5_min,`value5_max`= $value5_max WHERE fish_pond = $fish_pond";
    ...
    if ($conn->query($sql3) === TRUE) {
        ...
        $sql4 = "UPDATE `operator` SET `fish_pond`= $fish_pond,`operator_1`= $operator_1,`operator_2`= $operator_2,
        `operator_3`= $operator_3,`operator_4`= $operator_4 WHERE fish_pond = $fish_pond ";
    ...
    if ($conn->query($sql4) === TRUE) {
        ...
        $sql5 = " UPDATE `couple` SET `fish_pond`= $fish_pond,`sensor_1`= $sensor_1,`sensor_2`= $sensor_2,
        `sensor_3`= $sensor_3,`sensor_4`= $sensor_4,`sensor_5`= $sensor_5 WHERE fish_pond = $fish_pond";
    ...
    if ($conn->query($sql5) === TRUE) {
        ...
        $sql6 = "UPDATE `ratio_food` SET `fish_pond`= $fish_pond ,`ratio_1`= $ratio_1 ,`ratio_2`= $ratio_2,`ratio_3`= $ratio_3 WHERE fish_pond = $fish_pond";
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <input name="fishname" id="fishname" type="text" class="form-control" value="<?php echo $row['name_animal']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <input name="fish_pond" id="fish_pond" type="text" class="form-control" value="<?php echo $row['fish_pond']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <input name="agey" id="agey" type="text" class="form-control" value="<?php echo $row['year_age']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <input name="agem" type="text" class="form-control" value="<?php echo $row['month_age']; ?>" required>
                                    </div>

                                    <div class="form-group">
                                        <input name="amount" type="text" class="form-control" value="<?php echo $row['amount_animal']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <input name="datet" id="datepicker" class="form-control" value="<?php echo $row['date_release']; ?>" required>

                                    </div>
                                    <div class="form-group">
                                        <input name="quantity" id="quantity" type="text" class="form-control" value="<?php echo $row['quantity_food']; ?>" required>
                                    </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div id="gen_time_feed" class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input name="timefood1" class="form-control" placeholder="เวลาในการให้อาหาร" id="timepicker1" required>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="card-body shadow-lg  bg-white rounded ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input name="value1_min" id="value1_min" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(ต่ำสุด)" value="<?php echo $row['value1_min']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input name="value2_min" id="value2_min" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(ต่ำสุด)" value="<?php echo $row['value2_min']; ?>">
                                    </div>
                                    <div class="input-group mb-3">
                                    ...
                                    <div class="form-group">
                                        <input name="value3_min" id="value3_min" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(ต่ำสุด)" value="<?php echo $row['value3_min']; ?>">
                                    </div>
                                    <div class="input-group mb-3">
                                    ...
                                    <div class="form-group">
                                        <input name="value4_min" id="value4_min" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(ต่ำสุด)" value="<?php echo $row['value4_min']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input name="value5_min" id="value5_min" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(ต่ำสุด)" value="<?php echo $row['value5_min']; ?>">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group" style="margin-top:55px;">
                                        <input name="value1_max" id="value1_max" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(สูงสุด)" value="<?php echo $row['value1_max']; ?>">
                                    </div>

                                    <div class="form-group" style="margin-top:125px;">
                                        <input name="value2_max" id="value2_max" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(สูงสุด)" value="<?php echo $row['value2_max']; ?>">
                                    </div>

                                    <div class="form-group" style="margin-top:125px;">
                                        <input name="value3_max" id="value3_max" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(สูงสุด)" value="<?php echo $row['value3_max']; ?>">
                                    </div>

                                    <div class="form-group" style="margin-top:120px;">
                                        <input name="value4_max" id="value4_max" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(สูงสุด)" value="<?php echo $row['value4_max']; ?>">
                                    </div>

                                    <div class="form-group" style="margin-top:125px;">
                                        <input name="value5_max" id="value5_max" type="text" class="form-control" placeholder="ค่าเกณฑ์มาตรฐาน(สูงสุด)" value="<?php echo $row['value5_max']; ?>">
                                    </div>
